...
ig.global.EntityPasserby = ig.Entity.extend({
   ...
   // zIndex: 499,
    ...
    update: function() {
      //  this.setCurrentAnim();
        if (this.vel.x === this.speed && this.pos.x > 3741) {
            this.kill();
        }
        else if (this.vel.x === -this.speed && this.pos.x < 2000) {
            this.kill();
        }
    ...
    kill: function() {
        ...
        //    ig.game.spawnEntity(EntityPasserby, x, this.pos.y);
        }
        this.parent();
    },
